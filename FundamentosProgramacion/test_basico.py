...
def test_vector_basico():
    ...
    try:
        from Taller2_RodriguezD import Vector
...
def test_matrix_basico():
    ...
    try:
        from Taller2_RodriguezD import Matrix
...
def test_funciones_vector():
    ...
    try:
        from Taller2_RodriguezD import Vector, dot_product, magnitude, normalize
...
def test_funciones_matrix():
    ...
    try:
        from Taller2_RodriguezD import Matrix, Vector, add, scale, vector_multiply
...
def test_matrices_especiales():
    ...
    try:
        from Taller2_RodriguezD import identity_matrix, zeros_matrix, ones_matrix
